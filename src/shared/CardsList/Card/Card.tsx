    ...
    return (
        <li className={styles.card}>
                ...
                <div className={styles.metaData}>
                    <div className={styles.userLink}>
                        <img
                         ...
                         src="https://www.freelancejob.ru/upload/131/5092087670389.png"
                         alt='avatar'
                        />
                        <a href="#user-url" className={styles.username}>Дмитрий Егоров</a>
                    </div>
            ...
            <div className={styles.preview}>
                ...
                src='https://wallpaperaccess.com/full/2821437.jpg'
                />
            </div>
